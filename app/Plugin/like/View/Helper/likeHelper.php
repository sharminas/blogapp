...
class LikeHelper extends AppHelper{
	...
	public function like($model, $article_id, $option = array()){
	...
	public function dislike($model, $article_id, $option = array()){
	...
	public function display($likes, $userKey = 'firstname'){
