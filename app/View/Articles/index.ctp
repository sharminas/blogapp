            ...
            <?php if($articles):?>
               ...
               <div class="blog-post" id="content">
                  ...
                  <div class="blog-post-title">                
                     <h2 class="topic">
                        <?php echo $this->Html->link(__($article['Article']['title'],true), array('controller' => 'articles','action' =>'view',$article['Article']['id']));?>

                         <small class="author" title=" I'm <?php echo  $article['User']['firstname']?>, <?php echo $article['User']['about'] ?> <br> <?php echo __('please visit and read my article');?>" data-toggle="popover1" data-placement="right"> by : <?php echo $this->Html->link($article['User']['firstname'],array('controller' => '#', 'action' => '#', $article['User']['id']));?>
                         </small> 
                     </h2>
