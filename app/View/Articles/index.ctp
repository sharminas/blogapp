    ...
    <div class="container">
         ...
         <?php if($articles):?>
            ...
            <div class="blog-post" id="content">
               ...
               <div class="blog-post-title">                
                  <h2 class="topic">
                     <?php echo $this->Html->link(__($article['Article']['title'],true), array('controller' => 'articles','action' =>'view',$article['Article']['id']));?><small class="author"> by : <?php echo $this->Html->link($article['User']['firstname'],array('controller' => 'users', 'action' => 'view', $article['User']['id']));?></small> 
                  </h2>
      ...
      <div class="paging pull-left paginate">
