   ...
   <div class="row well">
      <div class="col-sm-3 col-md-3">
         <ul class="nav nav-sidebar profile">
            ...
            <li><span class="glyphicon glyphicon-cog" style="font-size: 20px; color:#ff471a; text-decoration:none;"><?php  echo $this->Html->link(__('Change Password'), array( 'controller' => 'users','action' => 'reset')); ?></span></li>&nbsp;
      ...
      <div class="col-sm-9 col-md-8">
         <h1><?php echo __('Add Article'); ?> </h1>
            <ul class="nav nav-sidebar">
               <?php echo $this->Form->input(__('title',true),array('class' => 'form-control', 'div' => array('class' => 'form-group'))); ?></ul>
