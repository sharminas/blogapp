  ...
  <div class="container">
      <div class="row">
        ...
        <div class="col-md-3">
          <h4 class="foot"><?php echo __('Active Users') ?> <hr style="color: red;"></h4>
            <?php if($users) :?>
              <?php foreach($users as $user):?>     
                  <p class="footer"><?php echo $this->Html->link($user['User']['firstname'],array('controller' => 'users','action' =>'view',$user['User']['id']));?></p>
                  <small><?php echo $this->Time->format('F j, Y h:i A',$user['User']['created']); ?></small>
